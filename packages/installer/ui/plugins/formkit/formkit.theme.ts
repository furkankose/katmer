...
export function rootClasses(
  ...
  return sectionClasses(
    ...
    sectionName,
    node.props.family,
    typeof node.props.classes?.[sectionName] === "string" ?
      { [node.props.classes[sectionName] as string]: true }
    : {},
    node.props?.attrs?.class
  )
}
export function sectionClasses(
  ...
  sectionName: string,
  family: string = type,
  ...additionals: (string | Record<string, boolean>)[]
): Record<string, boolean> {
  const key = `${type}__${sectionName}`
  const semanticKey = `formkit-${sectionName}`
  const familyKey = family ? `family:${family}__${sectionName}` : ""
  ...
  if (!(memoKey in classes)) {
    ...
    if (familyKey && familyKey in classes) {
      classes[memoKey] = { ...classes[familyKey], ...sectionClasses }
    } else {
      classes[memoKey] = sectionClasses
    }
  }
  let additional = {} as Record<string, any>

  for (const additionalClasses of additionals) {
    ...
    if (typeof additionalClasses === "string") {
      ...
      Object.entries(additionalClasses).forEach(([key, value]) => {
        ...
        additional = { ...additional, ...denormalized }
      })
    }
  }

  const res = {
    ...(additional.$reset ? {} : (classes[memoKey] ?? { [semanticKey]: true })),
    ...additional
  }
  ...
  const allowedClasses = twMerge(...allowed)

  const finalClasess = {
    ...Object.fromEntries(allowedClasses.split(" ").map((key) => [key, true])),
    ...Object.fromEntries(rejected.map((key) => [key, false]))
  }
  return finalClasess
}
...
export const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "dark:ring-offset-primary-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-primary-900": true,
    "dark:peer-checked:text-primary-400": true
  },
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-primary-500": true,
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-primary-500": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-primary-500": true
  },
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-primary-600": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-primary-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-primary-500": true,
    ...
    "[&::-moz-range-thumb]:bg-primary-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-primary-500": true,
  ...
  select__option: {
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:group-data-[multiple]:focus:bg-primary-800": true,
    "dark:group-data-[multiple]:checked:bg-primary-800": true
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-primary-600": true,
  ...
  datepicker__dayButton: {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-primary-500": true
  },
  ...
  datepicker__calendarIcon: {
    "text-neutral-600": true,
    "focus-visible:text-primary-600": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  repeater__fieldset: {
    ...
    "rounded-md": true,
    "group-data-[invalid]/repeater:border-red-500": true,
    "group-data-[invalid]/repeater:ring-1": true,
    "group-data-[invalid]/repeater:ring-red-500": true,
    "group-data-[disabled]/repeater:bg-neutral-100": true,
    "group-data-[disabled]/repeater:!cursor-not-allowed": true,
    "dark:group-data-[disabled]/repeater:bg-neutral-800/5": true,
    "dark:group-data-[invalid]/repeater:border-red-500": true,
    "dark:group-data-[invalid]/repeater:ring-red-500": true
  },
  repeater__legend: {
    block: true,
    "text-neutral-700": true,
  ...
  slider__tooltip: {
    ...
    "after:border-t-primary-600": true,
  ...
  toggle__track: {
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-primary-500": true,
  ...
  transferlist__outer: {
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-primary-600": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-primary-500": true,
    "dark:border-neutral-600": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-primary-900": true,
    "dark:aria-selected:bg-primary-900": true,
    "dark:ring-neutral-700": true,
    "dark:data-[is-active=true]:ring-primary-600": true,
    "dark:aria-selected:ring-primary-600": true,
